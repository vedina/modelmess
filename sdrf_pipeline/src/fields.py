...
FIELDS: list[SDRFField] = [
    ...
    SDRFField(
        ...
        examples=["45 years", "8 weeks", "adult"],
    ...
    SDRFField(
        ...
        examples=["Iodoacetamide", "Chloroacetamide"],
    ...
    SDRFField(
        ...
        examples=["FLAG-EGFP", "HA-BRCA1"],
    ),
    SDRFField(
        header="Characteristics[BiologicalReplicate]",
        attr="biological_replicate",
        description="Biological replicate number for this sample.",
        examples=["1", "2", "3"],
        regex=r'[_\-](rep)?(\d)[_\-\.]',
        high_value=True,
    ),
    SDRFField(
        ...
        examples=["HeLa", "HEK293T", "Jurkat"],
        regex=r'\b(HeLa|HEK293|Jurkat|U2OS|MCF-7|A549|K562|Huh7|CaCo-2|PC-3|LNCaP)\b',
    ),
    SDRFField(
        header="Characteristics[CellPart]",
        attr="cell_part",
        description="Subcellular fraction or compartment",
        examples=["nucleus", "cytoplasm", "mitochondria","cytosol"],
    ),
    SDRFField(
        ...
        examples=["T cell", "PBMC", "hepatocyte"],
    ),
    SDRFField(
    ...
    SDRFField(
        ...
        examples=["rapamycin", "EGF", "doxorubicin"],
    ),
    SDRFField(
    ...
    SDRFField(
        ...
        examples=["Carbamidomethyl", "TMT6plex"],
        high_value=True,
    ),
    SDRFField(
    ...
    SDRFField(
        ...
        description="Total number of biological replicates per condition.",
        examples=["3", "2", "4"],
    ...
    SDRFField(
        ...
        attr="organism_part",
        description="Tissue, organ, or biofluid of origin.",
    ...
    SDRFField(
        ...
        attr="organism",
        description="Latin binomial species name.",
    ...
    SDRFField(
        ...
        examples=["primary tumor", "metastasis"],
    ),
    SDRFField(
    ...
    SDRFField(
        ...
        description="Reagent used to reduce disulfide bonds.",
        examples=["Dithiothreitol", "TCEP"],
    ...
    SDRFField(
        ...
        attr="temperature",
        description="Temperature of experimental condition (e.g. heat treatment, incubation). Extract numeric value only without units. For raw/untreated controls use None.",
        examples=["37", "65", "80"],
        regex=r'(\d+)\s*°C',
        high_value=False,
        is_factor=True,
    ...
    SDRFField(
        ...
        examples=["30 min", "24 h", "72 h"],
        regex=r'(\d+\.?\d*)\s*(min|minutes?|h\b|hours?|days?)',
    ),
    SDRFField(
        header="Characteristics[Treatment]",
        attr="treatment",
        description="Experimental treatment applied to sample. 'none' for untreated controls. ",
    ...
    SDRFField(
        ...
        description="Mass spectroscopy acquisition strategy",
        examples=["data-dependent acquisition", "DDA", "data-independent acquisition","DIA", "PRM"],
    ...
    SDRFField(
        ...
        description="Enrichment method for PTMs or specific protein classes.",
        examples=["IMAC", "TiO2", "anti-phosphotyrosine"],
    ),
    SDRFField(
    ...
    SDRFField(
        ...
        description="Pre-fractionation method used before LC-MS",
        examples=["SCX", "HpRP", "gel-based", "IEF"],
    ),
    SDRFField(
        header="Comment[FragmentMassTolerance]",
        attr="fragment_mass_tolerance",
        description="MS2 mass tolerance used in database search. Include units (Da or ppm).",
    ...
    SDRFField(
        ...
        description="Ion fragmentation method.",
    ...
    SDRFField(
        ...
        attr="instrument",
        description="Mass spectrometer model. Use full model name.",
    ...
    SDRFField(
        ...
        description="Ion source type. Almost always ESI for LC-MS.",
...
def build_prompt_field_guide() -> str:
    ...
    lines = [
        ...
        "================================",
        "For EVERY field below, actively search the paper before writing None.",
        "",
    ]
    for f in FIELDS:
